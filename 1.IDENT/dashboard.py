...
class Interface():
    ...
    def corps(self):
        ...
        Tik.Button(self.menu_frame1, image=self.img_btn, borderwidth='0c', highlightthickness=0).place(relx=0.15, rely=0.4)
        Tik.Button(self.menu_frame1, text="Comptes", bg='#00bcd4', fg='black', font=18, overrelief="flat", borderwidth='0c', highlightthickness=0,activebackground='#00bcd4').place(relx=0.20, rely=0.50)

        Tik.Button(self.menu_frame1, image=self.img_btn, borderwidth='0c', highlightthickness=0).place(relx=0.55, rely=0.4)
        Tik.Button(self.menu_frame1, text="Budget", bg='#00bcd4', fg='black', font=18, overrelief="flat", borderwidth='0c', highlightthickness=0,activebackground='#00bcd4').place(relx=0.60, rely=0.50)
        ...
        Tik.Button(self.menu_frame2, image=self.img_btn1, borderwidth='0.05c', highlightthickness=0).place(relx=0.20, rely=0.3)
        
        self.img_btn2 = ImageTk.PhotoImage(file='Assets/home.png')
        Tik.Button(self.menu_frame2, image=self.img_btn2, borderwidth='0.05c', highlightthickness=0).place(relx=0.45, rely=0.3)
        
        self.img_btn3 = ImageTk.PhotoImage(file='Assets/edit.png')
        Tik.Button(self.menu_frame2, image=self.img_btn3, borderwidth='0.05c', highlightthickness=0).place(relx=0.70, rely=0.3)
